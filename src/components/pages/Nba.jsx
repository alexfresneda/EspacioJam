    ...
    return (
      <div>
        <div className="hero-container">
          <HeroSection
            title="Baloncesto"
            description="En la sección de baloncesto y NBA, comentamos las noticias de actualidad de la mejor liga de baloncesto del mundo de manera informal, pero sin renunciar a un análisis en profundidad. También hay espacio para la Liga Femenina y la Euroliga en Espacio Jam, pese a que se nos note nuestro pasado Ramireño. Además, charlamos con diversos profesionales del mundo del baloncesto en España y Estados Unidos."
        ...
        <div className="cards__container">
          <div className="cards__items">
            {episode
              .filter((items) => items.topic === "baloncesto")
              .map((episode, key) => {
                if (click) {
                  return (
                    <div key={key}>
